...
const Calendar = () => {
  ...
  // Store currentEvents in localStorage whenever it changes
  useEffect(() => {
      ...
      <Box display="flex" justifyContent="space-between">
        ...
        <Box flex="1 1 100%" ml="15px">
          <FullCalendar
            ...
            eventChange={handleEventChange} // Listen for event changes
            events={currentEvents} // Provide events from state
          />
        </Box>
      </Box>
    </Box>
